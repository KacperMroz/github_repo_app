...
void main() {
  group('HomeView', () {
    testWidgets('displays RepoSearchRow and Divider',
    ...
    testWidgets('displays ReposListView when repositories are not empty',
        (WidgetTester tester) async {
      final searchController = TextEditingController();
    ...
    testWidgets('displays "No repositories found" when repositories are empty',
        (WidgetTester tester) async {
      final searchController = TextEditingController();
      await tester.pumpWidget(
        MaterialApp(
